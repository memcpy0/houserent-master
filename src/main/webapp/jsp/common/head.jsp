...
<head>
    ...
    <script src="/assets/css/fonts/fa-solid-900.woff2"></script>
            ...
            <c:choose>
                <c:when test="${sessionScope.user == null}">
                    <ul class="nav-menu nav-menu-social align-to-right">
                        <li class="add-listing bg--linkedin">
...
<%--                                            <a href="/admin/news">--%>
<%--                                                <i class="ti-new-window"></i>新闻管理--%>
<%--                                            </a>--%>
<%--                                            <a href="/admin/feedback">--%>
<%--                                                <i class="ti-alert"></i>反馈列表--%>
<%--                                            </a>--%>
                                            <a href="/admin/user">
